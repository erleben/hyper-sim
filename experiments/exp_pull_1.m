...
cable = [-65, 0.0, 0.0];
for i = 2:130/5+1
    cable = [cable; cable(end, :) + [5.0, 0.0, 0.0]];
end
% Create the scene for the simulation
scene  = pull_create_scene(1, '../', cable, false,  'model1.12.mat');
% Create the parameters for 'ecoflex-00-50' silicone, and use an adaptive
% step in the simulation
params = create_params('ecoflex-00-50','adaptive', 0.95, 0.001, false, true, 2.5, 1e9, false); 
%params.E = 5000;
params.k = 5e7;
% Create profile info
pinfo  = create_profile_info();
pinfo.output_path = '../output/exp_pull_1/';
% Data generated by the simulation
pdata = simulate( params, method, scene, pinfo); 
save('exp_pull_1_pdata.mat', 'pdata');
save('exp_pull_1_pinfo.mat', 'pinfo');
% Process the data
