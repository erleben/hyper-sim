...
params = create_params('ecoflex-00-50','adaptive', 1.0, 0.001, false, true, 10, 1e9, true); 
%params.E = 5000;
params.k = 5e9;
% Create profile info
pinfo  = create_profile_info();
pinfo.output_path = '../output/exp_pull_3/';
% Data generated by the simulation
pdata = simulate( params, method, scene, pinfo); 
save('exp_pull_3_pdata.mat', 'pdata');
save('exp_pull_3_pinfo.mat', 'pinfo');
% Process the data
