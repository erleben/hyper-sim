...
add_cable_forces       = @fem_add_cable_forces;
add_gravity            = @fem_add_gravity;
compute_gravity        = @fem_compute_gravity;
add_pressure_forces    = @fem_add_pressure_forces;
...
method = struct(...
  ...
  'add_cable_forces', add_cable_forces, ...
  'add_pressure_forces', add_pressure_forces, ...
