function [ BC ] = twist3_create_boundary_conditions( time, state, mesh )
%TWIST3_CREATE_BOUNDARY_CONDITIONS -- Creates a fixed position boundary condition.
%
% INPUT:
%
